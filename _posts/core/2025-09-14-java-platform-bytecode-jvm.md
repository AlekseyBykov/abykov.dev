...
Сама по себе виртуальная машина не знает, что такое `.java`, ее интересует только `.class` с байткодом.
...
> ⚠️ В старых версиях Java все библиотеки лежали в файле `rt.jar`. Начиная с Java 9 они организованы в отдельные модули (например, `java.base`, 
> `java.sql`, `java.xml`).
